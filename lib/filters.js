...
function addDefaults(filters) {
	 ...
	 */
	filters.date = function (input, format, offset, abbr) {
		var l = format.length,
	 ...
	 */
	filters["default"] = function (input, def) {
	 ...
	 */
	filters.escape = function (input, type) {
	 ...
	 */
	filters.groupBy = function (input, key) {
		if (!utils.isArray(input)) {
			return input;
		}
	 ...
	 * @return {string}
	 */
	filters.join = function (input, glue) {
		if (utils.isArray(input)) {
 ...
 * //    }
	 ...
	 */
	filters.json = function (input, indent) {
		return JSON.stringify(input, null, indent || 0);
	};
	filters.json_encode = exports.json;
	 ...
	 */
	filters.raw = function (input) {
		return exports.safe(input);
	};
	filters.raw.safe = true;
	 ...
	 */
	filters.replace = function (input, search, replacement, flags) {
	 ...
	 */
	filters.reverse = function (input) {
	 ...
	 * @return {*}        Sorted array;
	 */
	filters.sort = function (input, reverse) {
		var out, clone;
		if (utils.isArray(input)) {
	 ...
	 */
	filters.striptags = function (input) {
	 ...
	 */
	filters.url_encode = function (input) {
	 ...
	 */
	filters.url_decode = function (input) {
...
module.exports = exports = addDefaults(function () {
  return addDefaults();
});
